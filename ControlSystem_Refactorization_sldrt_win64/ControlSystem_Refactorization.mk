...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2025a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := ControlSystem_Refactorization
MODULES              := ControlSystem_Refactorization_data.c ControlSystem_Refactorization_tgtconn.c rtGetInf.c rt_nonfinite.c
MAKEFILE             := ControlSystem_Refactorization.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2025a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ControlSystem_Refactorization_ref.rsp
...
# additional includes
REQ_INCLUDES += ;$(WQ)C:/Users/david/PROYEC~1/CONTRO~1/Matlab/Github/REALTI~2$(WQ);$(WQ)C:/Users/david/PROYEC~1/CONTRO~1/Matlab/Github/REALTI~2/ControlSystem_Refactorization_sldrt_win64$(WQ);$(WQ)$(MATLAB_ROOT)/extern/include$(WQ);$(WQ)$(MATLAB_ROOT)/simulink/include$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src$(WQ);$(WQ)$(MATLAB_ROOT)/rtw/c/src/ext_mode/common$(WQ);$(WQ)$(MATLAB_ROOT)/toolbox/coder/rtiostream/src$(WQ)
